...
public class AdmobController : MonoBehaviour
{
...
#if UNITY_ANDROID || UNITY_IOS
    [HideInInspector] public AdPosition bannerPosition = AdPosition.Bottom;
#endif
    ...
    [HideInInspector] public string androidVideo;

    [Header("IOS")]
    public string iosID;
    public string iosInterstitialId;
    public string iosBanner;
    [HideInInspector] public string iosVideo;
#if UNITY_ANDROID || UNITY_IOS
    ...
    {
#if UNITY_ANDROID
        string appId = androidInterstitialID;
#elif UNITY_IPHONE
            string appId = iosInterstitialId;
#else
            string appId = "unexpected_platform";
#endif
#if UNITY_ANDROID || UNITY_IOS
